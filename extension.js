...
function activate(context) {
	...
	console.log('Congratulations, your extension "unicode-escape-paste.paste" is now active!');
	...
	let disposable = vscode.commands.registerCommand('unicode-escape-paste.paste', function () {
